...
beautiful.init("/home/vl/.config/awesome/themes/zenburn/theme.lua")
...
beautiful.notification_max_height 	= 60
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1: ", "2: ", "3: ", "4: ", "5: ", "6: ", "7:󰙯 ", "8:󰓓 ", "9: "}, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "r",     function () menubar.show() end,
              {description = "run menubar", group = "launcher"}),
    ...
    awful.key({  }, "XF86AudioNext", function() awful.spawn("playerctl next") end,
        {description = "Next", group = "launcher"}),
    awful.key({  }, "XF86AudioPrev", function() awful.spawn("playerctl previous") end,
        {description = "Previous", group = "launcher"})
)
...
awful.rules.rules = {
    ...
    { rule = { class = "kitty" }, properties = { tag = "3: " } },
    { rule = {class = "discord"}, properties = {tag = "7:󰙯 "}},
    { rule = {class = "steam"}, properties = {tag = "8:󰓓 "}},
    { rule = {class = "Lutris"}, properties = {tag = "8:󰓓 "}},
    { rule = {class = "battle.net.exe"}, properties = {tag = "8:󰓓 "}},
...
client.connect_signal("manage", function (c)
    ...
    if c.class == nil then
        c.minimized = true
        c:connect_signal("property::class", function () c.minimized = false awful.rules.apply(c) end)
    end
    if awesome.startup
